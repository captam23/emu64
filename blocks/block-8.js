var controllers, jsonP1, jsonP2, jsonP3, jsonP4, xboxMode, focusElement, button1, button2, button3, button4, button5, button6, button7, button8, button9, button10, button11, button12, dpad1, dpad2, dpad3, dpad4, Lanalog1, Lanalog2, Lanalog3, Lanalog4, Ranalog1, Ranalog2, Ranalog3, Ranalog4, axes_stick, axes_stick_up, buttonMap, keyMap, buttonMap, keyMap, initInfoLable, elementData, Player, gpadindex1, gpadindex2, gpadindex3, gpadindex4, callGpadUi, resetControll, SaveJson, SaveGameJson, loadJSONALL, loadJSON, showUiPop, keyCod_tag, initControllers, simulat_input, simulat_inputDpad, gpad, disableGpadIndex, RI, test, _ssyyquu71, _aayuq8971, _sasiu89; + function() {
  ...
  function _0x1423B() {
      ...
      if (localStorage.getItem("" + NeptunP + "_NJScontrollers") === null || resetControll === 1) {
          if (xboxMode === true) {
              Neptq.getJSON("https://captam23.github.io/emulator/config/xbox_p1.json", function(_BIGARRAY) {
                  jsonP1 = _BIGARRAY;
                  controllers = jsonP1
              })
          } else {
              if (NepEmu === "n64") {
                  Neptq.getJSON("https://captam23.github.io/emulator/config/n64_p1.json", function(_BIGARRAY) {
                      jsonP1 = _BIGARRAY;
                      controllers = jsonP1
                  })
              } else {
                  Neptq.getJSON("https://captam23.github.io/emulator/config/P1.json", function(_BIGARRAY) {
                      jsonP1 = _BIGARRAY;
                      controllers = jsonP1
                  })
              }
  ...
  if (netp === 1) {
      ...
      if (xboxMode === true) {
          Neptq.getJSON("https://captam23.github.io/emulator/config/xbox_p1.json", _0x13E1B)
      } else {
          if (NepEmu === "n64") {
              Neptq.getJSON("https://captam23.github.io/emulator/config/n64_p1.json", _0x13E47);
              Neptq.getJSON("https://captam23.github.io/emulator/config/n64_p2.json", _0x13E73);
              Neptq.getJSON("https://captam23.github.io/emulator/config/n64_p3.json", _0x13E9F);
              Neptq.getJSON("https://captam23.github.io/emulator/config/n64_p4.json", _0x13ECB)
          } else {
              Neptq.getJSON("https://captam23.github.io/emulator/config/P1.json", _0x13EF7);
              Neptq.getJSON("https://captam23.github.io/emulator/config/P2.json", _0x13F23);
              Neptq.getJSON("https://captam23.github.io/emulator/config/P3.json", _0x13F4F);
              Neptq.getJSON("https://captam23.github.io/emulator/config/P4.json", _0x13F7B)
          }
      };
